                ...
                <div class="card-body">
                    <form action="{{ route('questions.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="question_title" value="{{ old('title') }}" class="form-control {{ $errors->has('title') ? 'is-invalid' : ''}}">
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body" id="question_body" rows="10"class="form-control {{ $errors->has('body') ? 'is-invalid' : ''}}">{{ old('body') }}</textarea>
                            @if ($errors->has('body'))
